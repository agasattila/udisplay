...
{
    /* v1 merkle root from protocol_vectors.json — 39-byte format since proto 0x04 (current: 0x05) */
    ...
    EXPECT_EQ(buf[1], 0x05u);           /* proto_version = UDISPLAY_PROTO_VERSION */
...
TEST(ProtoEncode, Handshake_ExactBytes)
{
    ...
    static const uint8_t expected[] = {
        0x00,0x05,0x00,  /* msg_type, proto_version, flags=0 */
        0x74,0xac,0x9f,0xa6,0x84,0x28,0x7d,0x0c,
        0xab,0x3e,0x64,0xe3,0xf2,0x5e,0xe3,0x69,
        0xc7,0x4b,0x46,0xe7,0xf2,0xec,0x00,0x25,
        0xcd,0x10,0xba,0xc7,0xbd,0xff,0xdb,0x6e,
...
TEST(ProtoEncode, HandshakeAuth_36bytes)
{
    ...
    static const uint8_t expected[] = {
        0x00,0x05,0x01,0x01,  /* msg_type, proto_version, flags=1, algo=SHA-256 */
        0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08,
        0x09,0x0a,0x0b,0x0c,0x0d,0x0e,0x0f,0x10,
        0x11,0x12,0x13,0x14,0x15,0x16,0x17,0x18,
        0x19,0x1a,0x1b,0x1c,0x1d,0x1e,0x1f,0x20
