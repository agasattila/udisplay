...
| [demo04](demo04/) | MicroPython PC emulator, matching demo01–03's simulation | Works (`--lang micropython`, TCP-only v0; verified end-to-end against a real MicroPython 1.24.1 Unix build, not just CPython) |
...
| [demo06](demo06/) | ESP8266 MicroPython over WiFi TCP | Placeholder — blocked on hardware (the MicroPython codegen backend itself is done) |
