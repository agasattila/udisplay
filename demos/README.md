...
| [demo04](demo04/) | MicroPython PC emulator, matching demo01–03's simulation | Works (`--lang micropython`, TCP-only v0; verified under CPython, not yet on the MicroPython Unix port) |
